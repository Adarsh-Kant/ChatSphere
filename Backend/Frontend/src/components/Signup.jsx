    ...
    <>
      <div className="flex h-screen items-center justify-center px-4 py-8">
        <form
          ...
          className="border border-black px-4 sm:px-8 py-6 sm:py-7 rounded-lg shadow-lg space-y-3 w-full max-w-md"
        >
          <h1 className="text-3xl sm:text-4xl items-center text-blue-700 font-bold">
            ChatSphere
          </h1>
          <h2 className="text-lg sm:text-2xl items-center">
            Create A New{" "}
